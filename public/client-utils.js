 ...
 *
 * Wrapped in an IIFE for browser execution so the inner function declarations do not
 * leak onto the global object, which would cause "duplicate variable" errors in
 * WebKit/Safari when app.js destructures the same names from window.clientUtils.
 */
(function () {
